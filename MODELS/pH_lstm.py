...
s_x, s_y, window = pickle.load(
    open('C:\\Users\\Henry\\PycharmProjects\\MPC project\\pickles\\lstm_needed_Param.pkl', 'rb'))

lstm_mdl = model_defrost(file_path='C:\\Users\\Henry\\PycharmProjects\\MPC '
...
def lstm(u_suggest, u, ph, ph_hat):
    ...
    for i in range(window, len(Xs)):
        ...
        Xs[i][(Xs.shape[1] - Ys.shape[1]):] = lstm_mdl(x=tf.constant(Xin))[0][0].numpy()
